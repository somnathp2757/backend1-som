...
import { Constants, ErrorNameConditionMapper, delay, retry, RetryMode, RetryOperationType, } from "@azure/core-amqp";
...
export async function retryForever(args, retryFn = retry) {
    ...
    while (true) {
        ...
        try {
            ...
            await delay(delayInMs, config.abortSignal, "Retry cycle has been cancelled by the user.");
            continue;
        }
    }
}
